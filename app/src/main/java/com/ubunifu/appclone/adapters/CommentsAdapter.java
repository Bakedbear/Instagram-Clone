...
public class CommentsAdapter extends RecyclerView.Adapter<CommentsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.name.setText(comment.getNames());

        Glide.with(mContext).load(mCommentArrayList.get(position).getProfile_img_url()).placeholder(R.drawable.profile).into(holder.profImg);
